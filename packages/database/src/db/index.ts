...
export async function ensureTables() {
  ...
  await client.exec(`
    CREATE TABLE IF NOT EXISTS match_timer_state (
      ...
      injury_time_ms BIGINT DEFAULT 0,
  ...
  // Support injury time on timer state
  await client.exec(`ALTER TABLE match_timer_state ADD COLUMN IF NOT EXISTS injury_time_ms BIGINT DEFAULT 0;`);
}
